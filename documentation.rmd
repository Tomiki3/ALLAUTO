...
Sur l'écran du pc est affiché un username particulier.
...
SALLE D'ATTENTE : Des tableaux sont affichés sur le mur. Ces tableax commémorent des évènements. Parmi eux, la création de l'entreprise.
La date y est écrite.

BUREAU DU PATRON : Bureau fermé par code. Ce code est la date de création de l'entreprise.
Sur le bureau du patron se trouve le badge du patron.

SALLE DE RÉUNION :
La porte est fermée à clef. Il faut un badge pour l'ouvrir (de préférence celui du patron).
Feuille avec tous les mdp attribués par défault aux employés sur une table. Un des mdp correspond au username initial.
